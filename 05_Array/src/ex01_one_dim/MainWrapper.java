...
public class MainWrapper {
   ...
   *  (int)0, (double)0.0, (boolean)false, (참조) null 값으로 초기화된다.
   * 3. 배열요소 호출 방법
   *    배열명[인덱스]
   */
  ...
  public static void ex01() {
    ...
    // 배열요소 확인
     ...
     // System.out.println(a[5]); // 인덱스의 범위를 벗어난 배열요소 : 예외가 발생한다. 
  ...
  public static void ex02() {
    ...
    for(int i = 0; i< length; i++ ) {
      System.out.println(a[i]); // a[0], a[1], a[2],a[3] 2[4]를 순서대로 호출 
    }
  ...
  public static void ex03() {
    ...
    for(int i = 0; i< a.length; i++) { // 배열에 저장된 배열길이 값 얼마인지 알 수 있다. 
  ...
  public static void ex08() {
    ...
    */
    System.arraycopy(a, 0, b, 0, a.length);  // 배열 a의 인덱스 0부터 복사 시작, 배열 b의 인덱스 0으로 보내기 시작, a.lengh개 복사
    ...
    // 0x 1000000 영역의 메모리 누수가 발생한다. 
    // 이런 영역을 C++ 언어에서는 delete 명령으로 개발자가 직접 메모리 공간을 해제해야 하지만, 
    ...
    // 배열 a를 출력할 수 있는 형태로 만드는 Jave의 기능
  }
