...
public class MainWrapper {
  ...
  public static void ex01() {
    ...
    try {
      ...
      // 반복문 : 읽은 문자가 -1 아니면 계속 읽는다.
      while((ch = fr.read()) != -1) {
        sb.append((char)ch);    // 읽어드린 문자를 추가 및 캐릭터로 변형
  ...
  public static void ex02() {
    ...
    try {
      ...
      // read(char[] cbuf) 메소드
      // 1. 파라미터로 전달 된 char[] cbuf에 읽은 문자를 저장한다.
      // 2. 실제로 읽은 글자 수를 반환한다.
  ...
  public static void ex03() {
    ...
    try {
      ...
      // 버퍼입력스트림 생성(반드시 예외처리 필요, 파일이 없으면 FileNotFoundException)
  ...
  public static void ex04() {
    ...
    // 바이트 출력스트림으로 보낸 문자를 문자 입력스트림으로 읽기
