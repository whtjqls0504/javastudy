...
public class JSON_Library {
  ...
  public static void ex03() {
    ...
    String name = obj.getString("name");      // String name = obj.get("name");
    int age = obj.getInt("age");              // int age = (int)obj.get("age");  - 캐스팅.
  ...
  public static void main(String[] args) {
    // JSON 사용을 위해서는자바 라이브러리의 확장자 jar 파일이 있어야한다.
    ex05();
  }
