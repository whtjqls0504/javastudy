...
public class MainWrapper {
  ...
  public static void q4() {
    ...
    System.out.println(month + "월은 " +  lastDay[month] + "월은 잘못된 정보입니다.");
    }
  }
  ...
  public static void q6() {
    ...
    int[] count = new int[unit.length]; // count는 답을 적는 곳이며, length는 갯수이다.    
  ...
  public static void q7() {
    ...
    if(second < 60) {
      ...
      System.out.println(second + "초는" + (second / 3600) + "시간 " + (second % 3600 / 60) + "분 " + (second % 3600 % 60) + "초입니다.");
    }
	...
	public static void q8() {
		int number = 1234567;
		if(number / 100000  % 2 == 1) { // 첫번째 글자를 알아내기 위한 / 10000
...
//		
	  outer:
	   for(int dan = 2; dan <= 5; dan++) {
	      for(int n=1; n<=9; n++) {      
	        System.out.println(dan + "x" + n + "=" + (dan * n));  
	        if(dan == 5 && n == 5) {     // dan = 5와 같거나 n은 
	          break outer; // 바깥쪽 for문으로 돌아간 것. 
