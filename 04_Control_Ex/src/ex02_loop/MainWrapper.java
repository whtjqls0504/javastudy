...
public class MainWrapper {
  ...
  public static void ex02() {
    ...
    final int GOAL = 100000;  // 목표 모금액 -> 상수값(변하지 않는 값)으로 변환.
...
//    String str2 = String.format("%3d", 10); // 두 자리 정수
//    String str3 = String.format("%4d", 10); // 네 자리 정수
//    
//    String str4 = String.format("%-3d", 10);  // 마이너스 3자리
//    String str5 = String.format("%-4d", 10); // 마이너스 4자리 
//
//
