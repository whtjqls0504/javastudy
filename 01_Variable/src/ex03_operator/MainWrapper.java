...
public class MainWrapper {
  ...
  public static void ex01() {
    ...
    // 미션. 정수끼리 계산해 실수 결과 도출하기 
    int i = 5;
    int j = 2;
    
    double result = (double) i / j; // 5.0 / 2  ->  5.0 / 2.0 (자동타입변환)
    System.out.println(result); // 2.5
  }

  
  // ex02 메소드 정의 >> 증감 연산, 전위연산 / 후위연산
  ...
  // 참고. 문자열로 변환하는 메소드가 있다.
    String str6 = String.valueOf(100); // 잘 안 쓸뿐, 있다.
