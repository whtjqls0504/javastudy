...
public class Ex01_String {
  ...
  public static void ex08() {
    ...
    // indexOf 메소드
    // 1. 특정 문자열의 인덱스를 반환.
    // 2. 특정 문자열이 2개 이상 존재하는 경우 발견된 첫 번째 문자열의 인덱스를 반환한다.
    // 3. 발견되지 않으면 -1을 반환
    ...
    int idx4 = statement.indexOf("tom");  // -1 반환된다.
  ...
  public static void ex11() {
    ...
    // isBlank 메소드
    // 1. 빈 문자열 이거나, 공백 문자로 구성되었다면 true 반환 아니면 false 반환.
  ...
  public static void ex12() {
    ...
    System.out.println(String.format("%-5d", number));  // 5자리 10진수로 표시, 숫자를 왼족 정렬 처리
    System.out.println(String.format("%05d", number));  // 5자리 10진수로 표시, 숫자를 오른쪽 정렬 처리, 빈자리를 0으로 채움
    System.out.println(String.format("%-05d", number)); // 5자리 10진수로 표시, 숫자를 왼쪽 정렬 처리, 빈 자리를 0으로 채움
  ...
  public static void ex15() {
    ...
    String ip = "192.168.0.101";
    String str = ip.replace(".", "_");  // 192_168_0_101을 기대하지만 정규식 패턴에서 .는 모든 문자를 의미하므로 원하는 결과를 얻을 수 없다.
    System.out.println(str);
